      ...
      <View style={styles.wrapper}>
        ...
        <Modal
          ...
          onClosingState={this.onClosingState}>
            ...
            <Button onPress={() => this.refs.modal7.open()} style={styles.btn}>      Modal Out       </Button>
            <Button onPress={() => this.refs.modal2.open()} style={styles.btn}>Modal Out </Button>
            <Button onPress={() => this.refs.modal3.open()} style={styles.btn}>Modal Out </Button>
